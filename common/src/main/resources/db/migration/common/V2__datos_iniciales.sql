...
--
-- Host: localhost    Database: _tenant_template
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `subpermisos_roles`;
...
DROP TABLE IF EXISTS `manifestoimportacion`;
...
DROP TABLE IF EXISTS `conceptoabierto`;
...
DROP TABLE IF EXISTS `anexosparametros`;
...
--
-- Table structure for table `aliasalmacen`
--
...
--
-- Dumping data for table `aliasalmacen`
--

LOCK TABLES `aliasalmacen` WRITE;
/*!40000 ALTER TABLE `aliasalmacen` DISABLE KEYS */;
/*!40000 ALTER TABLE `aliasalmacen` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `anexos_terceros`
--
...
LOCK TABLES `anexos_terceros` WRITE;
/*!40000 ALTER TABLE `anexos_terceros` DISABLE KEYS */;
/*!40000 ALTER TABLE `anexos_terceros` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `anexositemsfactura`
--
...
--
-- Dumping data for table `anexositemsfactura`
--

LOCK TABLES `anexositemsfactura` WRITE;
/*!40000 ALTER TABLE `anexositemsfactura` DISABLE KEYS */;
/*!40000 ALTER TABLE `anexositemsfactura` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `anexositemsremision`
--
...
--
-- Dumping data for table `anexositemsremision`
--

LOCK TABLES `anexositemsremision` WRITE;
/*!40000 ALTER TABLE `anexositemsremision` DISABLE KEYS */;
/*!40000 ALTER TABLE `anexositemsremision` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `anexosparametros`
--
...
--
-- Dumping data for table `anexosparametros`
--

LOCK TABLES `anexosparametros` WRITE;
/*!40000 ALTER TABLE `anexosparametros` DISABLE KEYS */;
/*!40000 ALTER TABLE `anexosparametros` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `anexosproducto`
--
...
--
-- Dumping data for table `anexosproducto`
--

LOCK TABLES `anexosproducto` WRITE;
/*!40000 ALTER TABLE `anexosproducto` DISABLE KEYS */;
/*!40000 ALTER TABLE `anexosproducto` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `anexosreciboingreso`
--
...
--
-- Dumping data for table `anexosreciboingreso`
--

LOCK TABLES `anexosreciboingreso` WRITE;
/*!40000 ALTER TABLE `anexosreciboingreso` DISABLE KEYS */;
/*!40000 ALTER TABLE `anexosreciboingreso` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `anexotercero`
--
...
--
-- Dumping data for table `anexotercero`
--

LOCK TABLES `anexotercero` WRITE;
/*!40000 ALTER TABLE `anexotercero` DISABLE KEYS */;
/*!40000 ALTER TABLE `anexotercero` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `asientos_contables_lineas`
--

LOCK TABLES `asientos_contables_lineas` WRITE;
/*!40000 ALTER TABLE `asientos_contables_lineas` DISABLE KEYS */;
/*!40000 ALTER TABLE `asientos_contables_lineas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `asientos_fallidos`
--

LOCK TABLES `asientos_fallidos` WRITE;
/*!40000 ALTER TABLE `asientos_fallidos` DISABLE KEYS */;
/*!40000 ALTER TABLE `asientos_fallidos` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `auditoria_mantenimiento`
--
...
--
-- Dumping data for table `auditoria_mantenimiento`
--

LOCK TABLES `auditoria_mantenimiento` WRITE;
/*!40000 ALTER TABLE `auditoria_mantenimiento` DISABLE KEYS */;
/*!40000 ALTER TABLE `auditoria_mantenimiento` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `bderror`
--
...
LOCK TABLES `bderror` WRITE;
/*!40000 ALTER TABLE `bderror` DISABLE KEYS */;
/*!40000 ALTER TABLE `bderror` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `cantidadestotales`
--
...
LOCK TABLES `cantidadestotales` WRITE;
/*!40000 ALTER TABLE `cantidadestotales` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cantidadestotales` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `categorias_comprobantes` WRITE;
/*!40000 ALTER TABLE `categorias_comprobantes` DISABLE KEYS */;
INSERT INTO `categorias_comprobantes` VALUES (1,'Ventas'),(2,'Devoluciones'),(3,'Compras');
/*!40000 ALTER TABLE `categorias_comprobantes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `categoriascomprobantes`
--

LOCK TABLES `categoriascomprobantes` WRITE;
/*!40000 ALTER TABLE `categoriascomprobantes` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `categoriascomprobantes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `categoriasegresos`
--

LOCK TABLES `categoriasegresos` WRITE;
/*!40000 ALTER TABLE `categoriasegresos` DISABLE KEYS */;
/*!40000 ALTER TABLE `categoriasegresos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `categoriasingresos`
--

LOCK TABLES `categoriasingresos` WRITE;
/*!40000 ALTER TABLE `categoriasingresos` DISABLE KEYS */;
/*!40000 ALTER TABLE `categoriasingresos` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `clasificaciones_terceros` WRITE;
/*!40000 ALTER TABLE `clasificaciones_terceros` DISABLE KEYS */;
INSERT INTO `clasificaciones_terceros` VALUES (1,'Cliente'),(2,'Proveedor'),(3,'Empleado'),(4,'Cliente_proveedor');
/*!40000 ALTER TABLE `clasificaciones_terceros` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `comprobantes_contables`
--
...
--
-- Dumping data for table `comprobantes_contables`
--

LOCK TABLES `comprobantes_contables` WRITE;
/*!40000 ALTER TABLE `comprobantes_contables` DISABLE KEYS */;
/*!40000 ALTER TABLE `comprobantes_contables` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `conceptoabierto`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `conceptoabierto` (
  `codigo` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) NOT NULL,
...
--
-- Dumping data for table `conceptoabierto`
--

LOCK TABLES `conceptoabierto` WRITE;
/*!40000 ALTER TABLE `conceptoabierto` DISABLE KEYS */;
/*!40000 ALTER TABLE `conceptoabierto` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `configuracion_compras`
--

LOCK TABLES `configuracion_compras` WRITE;
/*!40000 ALTER TABLE `configuracion_compras` DISABLE KEYS */;
/*!40000 ALTER TABLE `configuracion_compras` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `configuracion_contabilidad`
--
...
--
-- Dumping data for table `configuracion_contabilidad`
--

LOCK TABLES `configuracion_contabilidad` WRITE;
/*!40000 ALTER TABLE `configuracion_contabilidad` DISABLE KEYS */;
INSERT INTO `configuracion_contabilidad` VALUES (1,1,NULL,'2026-07-23 15:33:16');
/*!40000 ALTER TABLE `configuracion_contabilidad` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `configuracion_contable_mapa`
--

LOCK TABLES `configuracion_contable_mapa` WRITE;
/*!40000 ALTER TABLE `configuracion_contable_mapa` DISABLE KEYS */;
/*!40000 ALTER TABLE `configuracion_contable_mapa` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=94286 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cuentas_contables` VALUES (93292,'4295','Otros ingresos no operacionales','INGRESO',5,NULL,1,'ACTIVO','2026-05-03 20:22:20',0,0,0),(93293,'5135','Gastos varios','GASTO',5,NULL,1,'ACTIVO','2026-05-03 20:22:20',0,0,0),(93294,'1105','Caja general','ACTIVO',5,NULL,0,'ACTIVO','2026-05-03 20:22:20',0,0,0),(93295,'5105','Sueldos y salarios','GASTO',5,NULL,1,'ACTIVO','2026-05-03 20:22:20',0,0,0),(93296,'1','ACTIVO','ACTIVO',1,NULL,0,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93297,'11','DISPONIBLE','ACTIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93298,'110505','Caja general','ACTIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93299,'110510','Cajas menores','ACTIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93300,'110515','Moneda extranjera','ACTIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93301,'1110','BANCOS','ACTIVO',3,NULL,0,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93302,'111005','Moneda nacional','ACTIVO',4,NULL,0,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93303,'111010','Moneda extranjera (bancos)','ACTIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93304,'1115','REMESAS EN TRANSITO','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93305,'1120','CUENTAS DE AHORRO','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93306,'1125','FONDOS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93307,'12','INVERSIONES','ACTIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93308,'1205','Acciones','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93309,'1215','Bonos','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93310,'1225','Certificados','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93311,'1230','Papeles comerciales','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93312,'1235','Titulos','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93313,'1295','Otras inversiones','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93314,'13','DEUDORES','ACTIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93315,'1305','CLIENTES','ACTIVO',3,NULL,0,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93316,'130505','Clientes nacionales','ACTIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93317,'130510','Clientes del exterior','ACTIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93318,'1310','CUENTAS CORRIENTES COMERCIALES','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93319,'1315','CUENTAS POR COBRAR A CASA MATRIZ','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93320,'1320','CUENTAS POR COBRAR A VINCULADOS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93321,'1325','CUENTAS POR COBRAR A SOCIOS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93322,'1330','ANTICIPOS Y AVANCES','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93323,'1335','DEPOSITOS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93324,'1345','INGRESOS POR COBRAR','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93325,'1355','ANTICIPO DE IMPUESTOS Y CONTRIBUCIONES','ACTIVO',3,NULL,0,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93326,'135515','Retencion en la fuente','ACTIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93327,'135517','Impuesto a las ventas retenido','ACTIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93328,'135518','Impuesto de industria y comercio retenido','ACTIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93329,'1365','CUENTAS POR COBRAR A TRABAJADORES','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93330,'1380','DEUDORES VARIOS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93331,'1399','PROVISIONES DEUDORES','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',1,0,0),(93332,'14','INVENTARIOS','ACTIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93333,'1405','MATERIAS PRIMAS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93334,'1410','PRODUCTOS EN PROCESO','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93335,'1430','PRODUCTOS TERMINADOS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93336,'1435','MERCANCIAS NO FABRICADAS POR LA EMPRESA','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93337,'1455','MATERIALES REPUESTOS Y ACCESORIOS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93338,'1460','ENVASES Y EMPAQUES','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93339,'1465','INVENTARIOS EN TRANSITO','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93340,'15','PROPIEDADES PLANTA Y EQUIPO','ACTIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93341,'1504','TERRENOS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93342,'1516','CONSTRUCCIONES Y EDIFICACIONES','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93343,'1520','MAQUINARIA Y EQUIPO','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93344,'1524','EQUIPO DE OFICINA','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93345,'1528','EQUIPO DE COMPUTACION Y COMUNICACION','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93346,'1540','FLOTA Y EQUIPO DE TRANSPORTE','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93347,'1592','DEPRECIACION ACUMULADA','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93348,'16','INTANGIBLES','ACTIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93349,'1605','CREDITO MERCANTIL','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93350,'1610','MARCAS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93351,'1615','PATENTES','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93352,'1635','LICENCIAS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93353,'17','DIFERIDOS','ACTIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93354,'1705','GASTOS PAGADOS POR ANTICIPADO','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93355,'1710','CARGOS DIFERIDOS','ACTIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:18',0,0,0),(93357,'2','PASIVO','PASIVO',1,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93358,'21','OBLIGACIONES FINANCIERAS','PASIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93359,'2105','BANCOS NACIONALES','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93360,'2110','BANCOS DEL EXTERIOR','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93361,'2115','CORPORACIONES FINANCIERAS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93362,'2120','COMPANIAS DE FINANCIAMIENTO COMERCIAL','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93363,'2195','OTRAS OBLIGACIONES','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93364,'22','PROVEEDORES','PASIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93365,'2205','NACIONALES','PASIVO',3,NULL,0,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93366,'220505','Proveedores nacionales','PASIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93367,'2210','DEL EXTERIOR','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93368,'2215','CUENTAS CORRIENTES COMERCIALES (Prov.)','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93369,'23','CUENTAS POR PAGAR','PASIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93370,'2305','CUENTAS CORRIENTES COMERCIALES (CxP)','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93371,'2320','A CONTRATISTAS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93372,'2335','COSTOS Y GASTOS POR PAGAR','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93373,'2355','DEUDAS CON ACCIONISTAS O SOCIOS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93374,'2365','RETENCION EN LA FUENTE','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93375,'2367','IMPUESTO A LAS VENTAS RETENIDO','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93376,'2368','IMPUESTO DE INDUSTRIA Y COMERCIO RETENIDO','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93377,'2370','RETENCIONES Y APORTES DE NOMINA','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93378,'2380','ACREEDORES VARIOS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93379,'24','IMPUESTOS GRAVAMENES Y TASAS','PASIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93380,'2404','DE RENTA Y COMPLEMENTARIOS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93381,'2408','IMPUESTO SOBRE LAS VENTAS POR PAGAR','PASIVO',3,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93382,'240801','IVA generado','PASIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93383,'240810','IVA descontable','PASIVO',4,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93384,'2412','DE INDUSTRIA Y COMERCIO','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93385,'2495','OTROS IMPUESTOS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93386,'25','OBLIGACIONES LABORALES','PASIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93387,'2505','SALARIOS POR PAGAR','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93388,'2510','CESANTIAS CONSOLIDADAS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93389,'2515','INTERESES SOBRE CESANTIAS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93390,'2520','PRIMA DE SERVICIOS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93391,'2525','VACACIONES CONSOLIDADAS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93392,'26','PASIVOS ESTIMADOS Y PROVISIONES','PASIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93393,'2605','PARA COSTOS Y GASTOS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93394,'2610','PARA OBLIGACIONES LABORALES','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93395,'27','DIFERIDOS','PASIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93396,'2705','INGRESOS RECIBIDOS POR ANTICIPADO','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93397,'28','OTROS PASIVOS','PASIVO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93398,'2805','ANTICIPOS Y AVANCES RECIBIDOS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93399,'2810','DEPOSITOS RECIBIDOS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',1,0,0),(93400,'2895','DIVERSOS','PASIVO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93401,'3','PATRIMONIO','PATRIMONIO',1,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93402,'31','CAPITAL SOCIAL','PATRIMONIO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93403,'3105','CAPITAL SUSCRITO Y PAGADO','PATRIMONIO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93404,'3115','APORTES SOCIALES','PATRIMONIO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93405,'33','RESERVAS','PATRIMONIO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93406,'3305','RESERVAS OBLIGATORIAS','PATRIMONIO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93407,'36','RESULTADOS DEL EJERCICIO','PATRIMONIO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93408,'3605','UTILIDAD DEL EJERCICIO','PATRIMONIO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93409,'3610','PERDIDA DEL EJERCICIO','PATRIMONIO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93410,'37','RESULTADOS DE EJERCICIOS ANTERIORES','PATRIMONIO',2,NULL,0,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93411,'3705','UTILIDADES ACUMULADAS','PATRIMONIO',3,NULL,1,'ACTIVO','2026-05-19 09:48:59',0,0,0),(93412,'4','INGRESOS','INGRESO',1,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93413,'41','OPERACIONALES','INGRESO',2,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93414,'4105','AGRICULTURA GANADERIA','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93415,'4120','INDUSTRIAS MANUFACTURERAS','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93416,'4130','CONSTRUCCION','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93417,'4135','COMERCIO AL POR MAYOR Y AL POR MENOR','INGRESO',3,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93418,'413505','Venta de mercancias','INGRESO',4,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93419,'413510','Comercio al detal','INGRESO',4,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93420,'4140','HOTELES Y RESTAURANTES','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93421,'4145','TRANSPORTE ALMACENAMIENTO Y COMUNICACIONES','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93422,'4150','ACTIVIDAD FINANCIERA','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93423,'4155','ACTIVIDADES INMOBILIARIAS','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93424,'4160','ENSENANZA','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93425,'4165','SERVICIOS SOCIALES Y DE SALUD','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93426,'4170','OTRAS ACTIVIDADES DE SERVICIOS','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93427,'4175','DEVOLUCIONES EN VENTAS','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93428,'42','NO OPERACIONALES','INGRESO',2,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93429,'4205','OTRAS VENTAS','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93430,'4210','FINANCIEROS','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93431,'4215','DIVIDENDOS Y PARTICIPACIONES','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93432,'4220','ARRENDAMIENTOS (Ingresos)','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93433,'4225','COMISIONES','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93434,'4230','HONORARIOS (Ingresos)','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93435,'4235','SERVICIOS (Ingresos)','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93436,'4255','RECUPERACIONES','INGRESO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93437,'5','GASTOS','GASTO',1,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93438,'51','OPERACIONALES DE ADMINISTRACION','GASTO',2,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93439,'5110','HONORARIOS','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93440,'5115','IMPUESTOS (Gastos)','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93441,'5120','ARRENDAMIENTOS','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93442,'5125','CONTRIBUCIONES Y AFILIACIONES','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93443,'5130','SEGUROS','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93444,'5140','GASTOS LEGALES','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93445,'5145','MANTENIMIENTO Y REPARACIONES','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93446,'5150','ADECUACION E INSTALACION','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93447,'5155','GASTOS DE VIAJE','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93448,'5160','DEPRECIACIONES','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93449,'5165','AMORTIZACIONES','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93450,'5195','DIVERSOS (Gastos)','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93451,'52','OPERACIONALES DE VENTAS','GASTO',2,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93452,'5205','GASTOS DE PERSONAL (Ventas)','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93453,'5235','SERVICIOS (Ventas)','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93454,'5295','DIVERSOS (Ventas)','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93455,'53','NO OPERACIONALES','GASTO',2,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93456,'5305','FINANCIEROS (Gastos)','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93457,'5310','PERDIDAS EN VENTA Y RETIRO DE BIENES','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93458,'5315','GASTOS EXTRAORDINARIOS','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93459,'5395','GASTOS DIVERSOS NO OPERACIONALES','GASTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93460,'54','IMPUESTO DE RENTA Y COMPLEMENTARIOS','GASTO',2,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93461,'6','COSTOS DE VENTAS','COSTO',1,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93462,'61','COSTO DE VENTAS Y SERVICIOS','COSTO',2,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93463,'6135','COMERCIO AL POR MAYOR Y AL POR MENOR (Costos)','COSTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93464,'62','COMPRAS','COSTO',2,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93465,'6205','DE MERCANCIAS','COSTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93466,'6210','DE MATERIA PRIMA','COSTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93467,'6225','DEVOLUCIONES EN COMPRAS','COSTO',3,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93468,'7','COSTOS DE PRODUCCION','COSTO_PRODUCCION',1,NULL,0,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93469,'71','MATERIA PRIMA','COSTO_PRODUCCION',2,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93470,'72','MANO DE OBRA DIRECTA','COSTO_PRODUCCION',2,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93471,'73','COSTOS INDIRECTOS','COSTO_PRODUCCION',2,NULL,1,'ACTIVO','2026-05-19 09:49:36',0,0,0),(93475,'11100501','Bancolombia Principal','ACTIVO',5,93302,1,'ACTIVO','2026-05-20 10:38:49',0,0,0),(93476,'11100502','Davivienda Corriente','ACTIVO',5,93302,1,'ACTIVO','2026-05-20 10:38:49',0,0,0),(93477,'11100503','Nequi','ACTIVO',5,93302,1,'ACTIVO','2026-05-20 10:38:49',0,0,0),(93478,'11100504','Daviplata','ACTIVO',5,93302,1,'ACTIVO','2026-05-20 10:38:49',0,0,0),(93479,'236505','Retención en la fuente','PASIVO',5,NULL,1,'ACTIVO','2026-05-25 19:36:06',1,0,0),(93480,'236540','Retención de IVA','PASIVO',5,NULL,1,'ACTIVO','2026-05-25 19:36:06',1,0,0),(93481,'236570','Retención de ICA','PASIVO',5,NULL,1,'ACTIVO','2026-05-25 19:36:06',1,0,0),(93482,'8','CUENTAS DE ORDEN DEUDORAS','ORDEN_DEUDORAS',1,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93483,'81','DERECHOS CONTINGENTES','ORDEN_DEUDORAS',2,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93484,'8105','BIENES Y VALORES ENTREGADOS EN CUSTODIA','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93485,'810505','Bienes y valores entregados en custodia','ORDEN_DEUDORAS',4,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93486,'8110','BIENES Y VALORES ENTREGADOS EN GARANTIA','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93487,'811005','Bienes y valores entregados en garantia','ORDEN_DEUDORAS',4,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93488,'8120','LITIGIOS Y/O DEMANDAS','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93489,'812005','Litigios y/o demandas','ORDEN_DEUDORAS',4,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93490,'83','DEUDORAS DE CONTROL','ORDEN_DEUDORAS',2,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93491,'8315','PROPIEDADES PLANTA Y EQUIPO TOTALMENTE DEPRECIADAS','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93492,'831505','Propiedad planta y equipo totalmente depreciada','ORDEN_DEUDORAS',4,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93493,'84','DERECHOS CONTINGENTES POR CONTRA (CR)','ORDEN_DEUDORAS',2,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93494,'8405','Derechos contingentes por contra','ORDEN_DEUDORAS',3,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93495,'9','CUENTAS DE ORDEN ACREEDORAS','ORDEN_ACREEDORAS',1,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93496,'91','RESPONSABILIDADES CONTINGENTES','ORDEN_ACREEDORAS',2,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93497,'9105','BIENES Y VALORES RECIBIDOS EN CUSTODIA','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93498,'910505','Bienes y valores recibidos en custodia','ORDEN_ACREEDORAS',4,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93499,'9110','BIENES Y VALORES RECIBIDOS EN GARANTIA','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93500,'911005','Bienes y valores recibidos en garantia','ORDEN_ACREEDORAS',4,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93501,'9120','LITIGIOS Y/O DEMANDAS','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93502,'912005','Litigios y/o demandas','ORDEN_ACREEDORAS',4,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93503,'93','ACREEDORAS DE CONTROL','ORDEN_ACREEDORAS',2,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93504,'9395','OTRAS CUENTAS DE ORDEN ACREEDORAS DE CONTROL','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93505,'939505','Otras cuentas de orden acreedoras de control','ORDEN_ACREEDORAS',4,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93506,'94','RESPONSABILIDADES CONTINGENTES POR CONTRA (DB)','ORDEN_ACREEDORAS',2,NULL,0,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93507,'9405','Responsabilidades contingentes por contra','ORDEN_ACREEDORAS',3,NULL,1,'ACTIVO','2026-07-08 09:26:35',0,0,0),(93509,'421040','Descuentos comerciales condicionados (pronto pago)','INGRESO',6,NULL,1,'ACTIVO','2026-07-14 00:00:00',0,0,0),(93510,'539540','Averias','GASTO',6,NULL,1,'ACTIVO','2026-07-14 00:00:00',0,0,0),(93511,'513535','Fletes','GASTO',6,NULL,1,'ACTIVO','2026-07-14 00:00:00',0,0,0),(93512,'530535','Descuentos comerciales condicionados (concedidos)','GASTO',6,93456,1,'ACTIVO','2026-07-14 12:11:04',0,0,0),(93513,'111505','Moneda nacional','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93514,'111510','Moneda extranjera','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93515,'112005','Bancos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93516,'112010','Corporaciones de ahorro y vivienda','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93517,'112015','Organismos cooperativos financieros','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93518,'112505','Rotatorios moneda nacional','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93519,'112510','Rotatorios moneda extranjera','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93520,'112515','Especiales moneda nacional','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93521,'112520','Especiales moneda extranjera','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93522,'120505','Agricultura, ganaderia, caza y silvicultura','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93523,'120530','Comercio al por mayor y al por menor','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93524,'120560','Actividad financiera','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93525,'1210','Cuotas o partes de interes social','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93526,'121505','Bonos publicos moneda nacional','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93527,'121510','Bonos publicos moneda extranjera','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93528,'121515','Bonos ordinarios','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93529,'1220','Cedulas','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93530,'122505','Certificados de deposito a termino (CDT)','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93531,'122510','Certificados de deposito de ahorro','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93532,'123505','Titulos de devolucion de impuestos (TIDIS)','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93533,'123510','Titulos financieros agroindustriales (TFA)','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93534,'1240','Aceptaciones bancarias o financieras','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93535,'1245','Derechos fiduciarios','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93536,'124505','Fideicomisos de inversion moneda nacional','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93537,'124510','Fideicomisos de inversion moneda extranjera','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93538,'1250','Derechos de recompra de inversiones negociadas (repos)','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93539,'1255','Obligatorias','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93540,'1260','Cuentas en participacion','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93541,'129505','Aportes en cooperativas','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93542,'129510','Derechos en clubes sociales','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93543,'1299','Provisiones (inversiones)','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93544,'130515','Deudores del sistema','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93545,'132005','Filiales','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93546,'132010','Subsidiarias','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93547,'132015','Sucursales','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93548,'1323','Cuentas por cobrar a directores','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93549,'132505','A socios','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93550,'132510','A accionistas','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93551,'1328','Aportes por cobrar','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93552,'133005','A proveedores','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93553,'133010','A contratistas','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93554,'133015','A trabajadores','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93555,'133020','A agentes','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93556,'133025','A concesionarios','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93557,'133030','De adjudicaciones','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93558,'1332','Cuentas de operacion conjunta','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93559,'133505','Para importaciones','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93560,'133510','Para servicios','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93561,'133515','Para contratos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93562,'133520','Para responsabilidades','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93563,'133525','Para juicios ejecutivos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93564,'133530','Para adquisicion de acciones, cuotas o derechos sociales','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93565,'133595','Otros','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93566,'1340','Promesas de compraventa','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93567,'134505','Dividendos y/o participaciones','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93568,'134510','Intereses','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93569,'134515','Comisiones','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93570,'134520','Honorarios','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93571,'134525','Servicios','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93572,'134530','Arrendamientos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93573,'134595','Otros','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93574,'1350','Retencion sobre contratos','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93575,'135505','Anticipo de impuesto de renta y complementarios','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93576,'135510','Anticipo de impuesto de industria y comercio','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93577,'135520','Sobrantes en liquidacion privada de impuestos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93578,'135525','Contribuciones','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93579,'135530','Impuestos descontables','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93580,'135595','Otros','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93581,'1360','Reclamaciones','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93582,'136005','A companias aseguradoras','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93583,'136010','A transportadores','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93584,'136095','Otras','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93585,'136505','Vivienda','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93586,'136510','Vehiculos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93587,'136515','Educacion','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93588,'136520','Medicos, odontologicos y similares','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93589,'136525','Calamidad domestica','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93590,'136530','Responsabilidades','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93591,'136595','Otros','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93592,'1370','Prestamos a particulares','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93593,'138005','Depositarios','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93594,'138010','Comisionistas de bolsas','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93595,'138020','Cuentas por cobrar de terceros','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93596,'138095','Otros','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93597,'1385','Derechos de recompra de cartera negociada','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93598,'1390','Deudas de dificil cobro','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93599,'139905','Clientes','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93600,'139995','Otros','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93601,'1415','Obras de construccion en curso','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93602,'1417','Obras de urbanismo','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93603,'1420','Contratos en ejecucion','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93604,'1425','Cultivos en desarrollo','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93605,'1428','Plantaciones agricolas','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93606,'1440','Bienes raices para la venta','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93607,'1445','Semovientes','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93608,'1450','Terrenos','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93609,'1499','Provisiones (inventarios)','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93610,'1506','Materiales proyectos petroleros','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93611,'1508','Construcciones en curso','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93612,'1512','Maquinaria y equipos en montaje','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93613,'152405','Muebles y enseres','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93614,'152410','Equipos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93615,'152805','Equipos de procesamiento de datos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93616,'152810','Equipos de telecomunicaciones','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93617,'1532','Equipo medico-cientifico','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93618,'1536','Equipo de hoteles y restaurantes','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93619,'154005','Autos, camionetas y camperos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93620,'154010','Camiones, volquetas y furgones','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93621,'1544','Flota y equipo fluvial y/o maritimo','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93622,'1548','Flota y equipo aereo','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93623,'1552','Flota y equipo ferreo','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93624,'1556','Acueductos, plantas y redes','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93625,'1560','Armamento de vigilancia','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93626,'1562','Envases y empaques','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93627,'1564','Plantaciones agricolas y forestales','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93628,'1568','Vias de comunicacion','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93629,'1572','Minas y canteras','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93630,'1576','Pozos artesianos','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93631,'1580','Yacimientos','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93632,'1584','Semovientes','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93633,'1588','Propiedades, planta y equipo en transito','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93634,'159205','Construcciones y edificaciones','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93635,'159210','Maquinaria y equipo','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93636,'159215','Equipo de oficina','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93637,'159220','Equipo de computacion y comunicacion','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93638,'159235','Flota y equipo de transporte','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93639,'1596','Depreciacion diferida','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93640,'1597','Amortizacion acumulada','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93641,'1598','Agotamiento acumulado','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93642,'1599','Provisiones (propiedades, planta y equipo)','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93643,'1620','Concesiones y franquicias','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93644,'1625','Derechos','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93645,'1630','Know how','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93646,'1698','Amortizacion acumulada (intangibles)','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93647,'1699','Provisiones (intangibles)','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93648,'170505','Intereses','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93649,'170510','Honorarios','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93650,'170515','Comisiones','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93651,'170520','Seguros y fianzas','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93652,'170525','Arrendamientos','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93653,'170595','Otros','ACTIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93654,'1715','Costos de exploracion por amortizar','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93655,'1720','Costos de explotacion y desarrollo','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93656,'1730','Cargos por correccion monetaria diferida','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93657,'1798','Amortizacion acumulada (diferidos)','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93658,'18','Otros activos','ACTIVO',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93659,'1805','Bienes de arte y cultura','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93660,'1895','Diversos','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93661,'1899','Provisiones (otros activos)','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93662,'19','Valorizaciones','ACTIVO',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93663,'1905','De inversiones','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93664,'1910','De propiedades, planta y equipo','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93665,'1995','De otros activos','ACTIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93727,'210505','Sobregiros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93728,'210510','Pagares','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93729,'210515','Cartas de credito','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93730,'210520','Aceptaciones bancarias','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93731,'2125','Corporaciones de ahorro y vivienda','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93732,'2130','Entidades financieras del exterior','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93733,'2135','Compromisos de recompra de inversiones negociadas','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93734,'2140','Compromisos de recompra de cartera negociada','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93735,'2145','Obligaciones gubernamentales','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93736,'219505','Particulares','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93737,'219510','Companias vinculadas','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93738,'219515','Casa matriz','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93739,'219520','Socios o accionistas','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93740,'2220','Casa matriz','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93741,'2225','Companias vinculadas','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93742,'2310','A casa matriz','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93743,'2315','A companias vinculadas','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93744,'2330','Ordenes de compra por utilizar','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93745,'233505','Gastos financieros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93746,'233510','Gastos legales','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93747,'233515','Libros, suscripciones, periodicos y revistas','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93748,'233520','Comisiones','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93749,'233525','Honorarios','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93750,'233530','Servicios tecnicos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93751,'233535','Servicios de mantenimiento','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93752,'233540','Arrendamientos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93753,'233545','Transportes, fletes y acarreos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93754,'233550','Servicios publicos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93755,'233555','Seguros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93756,'233560','Gastos de viaje','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93757,'233595','Otros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93758,'2340','Instalamentos por pagar','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93759,'2345','Acreedores oficiales','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93760,'2350','Regalias por pagar','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93761,'2357','Deudas con directores','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93762,'2360','Dividendos o participaciones por pagar','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93763,'236510','Dividendos y/o participaciones','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93764,'236515','Honorarios','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93765,'236520','Comisiones','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93766,'236525','Servicios','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93767,'236530','Arrendamientos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93768,'236535','Rendimientos financieros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93769,'236575','Autorretenciones','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93770,'237005','Aportes a entidades promotoras de salud (EPS)','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93771,'237006','Aportes a administradoras de riesgos laborales (ARL)','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93772,'237010','Aportes al ICBF, SENA y cajas de compensacion','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93773,'237025','Embargos judiciales','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93774,'237030','Libranzas','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93775,'237035','Sindicatos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93776,'237040','Cooperativas','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93777,'237045','Fondos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93778,'237095','Otros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93779,'2375','Cuotas por devolver','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93780,'238030','Fondos de cesantias y/o pensiones','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93781,'238095','Otros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93782,'240405','Vigencia fiscal corriente','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93783,'240410','Vigencias fiscales anteriores','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93784,'241205','Vigencia fiscal corriente','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93785,'241210','Vigencias fiscales anteriores','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93786,'2416','A la propiedad raiz','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93787,'2420','Derechos sobre instrumentos publicos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93788,'2424','De valorizacion','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93789,'2428','De turismo','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93790,'2432','Tasa por utilizacion de puertos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93791,'2436','De vehiculos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93792,'2440','De espectaculos publicos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93793,'2444','De hidrocarburos y minas','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93794,'2448','Regalias e impuestos a la pequena y mediana mineria','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93795,'2452','A las exportaciones cafeteras','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93796,'2456','A las importaciones','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93797,'2460','Cuotas de fomento','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93798,'2464','De licores, cervezas y cigarrillos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93799,'2468','Al sacrificio de ganado','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93800,'2472','Al azar y juegos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93801,'2476','Gravamen a los movimientos financieros','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93802,'251005','Ley laboral anterior','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93803,'251010','Ley 50 de 1990 y normas posteriores','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93804,'2530','Prestaciones extralegales','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93805,'2532','Pensiones por pagar','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93806,'2535','Cuotas partes pensiones de jubilacion','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93807,'2540','Indemnizaciones laborales','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93808,'261005','Cesantias','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93809,'261010','Intereses sobre cesantias','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93810,'261015','Vacaciones','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93811,'261020','Prima de servicios','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93812,'2615','Para obligaciones fiscales','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93813,'2620','Pensiones de jubilacion','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93814,'2625','Para obras de urbanismo','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93815,'2630','Para mantenimiento y reparaciones','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93816,'2635','Para contingencias','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93817,'2640','Para obligaciones de garantias','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93818,'2695','Provisiones diversas','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93819,'270505','Intereses','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93820,'270515','Comisiones','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93821,'270520','Arrendamientos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93822,'270525','Honorarios','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93823,'270530','Servicios tecnicos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93824,'270595','Otros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93825,'2710','Abonos diferidos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93826,'2715','Utilidad diferida en ventas a plazos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93827,'2720','Credito por correccion monetaria diferida','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93828,'2725','Impuestos diferidos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93829,'280505','De clientes','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93830,'280510','Sobre contratos','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93831,'280595','Otros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93832,'2815','Ingresos recibidos para terceros','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93833,'281505','Valores recibidos para terceros','PASIVO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93834,'2820','Cuentas de operacion conjunta','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93835,'2825','Retenciones a terceros sobre contratos','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93836,'2830','Embargos judiciales','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93837,'2835','Acreedores del sistema','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93838,'2840','Cuentas en participacion','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93839,'29','Bonos y papeles comerciales','PASIVO',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93840,'2905','Bonos en circulacion','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93841,'2910','Bonos obligatoriamente convertibles en acciones','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93842,'2915','Papeles comerciales','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93843,'2920','Bonos pensionales','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93844,'2925','Titulos pensionales','PASIVO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93889,'310505','Capital autorizado','PATRIMONIO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93890,'310510','Capital por suscribir (DB)','PATRIMONIO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93891,'310515','Capital suscrito por cobrar (DB)','PATRIMONIO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93892,'311505','Cuotas o partes de interes social','PATRIMONIO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93893,'3120','Capital asignado','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93894,'3125','Inversion suplementaria al capital asignado','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93895,'3130','Capital de personas naturales','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93896,'3135','Aportes del estado','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93897,'3140','Fondo social','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93898,'32','Superavit de capital','PATRIMONIO',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93899,'3205','Prima en colocacion de acciones, cuotas o partes de interes social','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93900,'3210','Donaciones','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93901,'3215','Credito mercantil','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93902,'3220','Know how','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93903,'3225','Superavit metodo de participacion','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93904,'330505','Reserva legal','PATRIMONIO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93905,'3310','Reservas estatutarias','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93906,'3315','Reservas ocasionales','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93907,'34','Revalorizacion del patrimonio','PATRIMONIO',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93908,'3405','Ajustes por inflacion','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93909,'3410','Saneamiento fiscal','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93910,'3415','Ajustes por inflacion Decreto 3019 de 1989','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93911,'35','Dividendos o participaciones decretados en acciones, cuotas o partes de interes social','PATRIMONIO',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93912,'3505','Dividendos decretados en acciones','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93913,'3510','Participaciones decretadas en cuotas o partes de interes social','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93914,'3710','Perdidas acumuladas','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93915,'38','Superavit por valorizaciones','PATRIMONIO',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93916,'3805','De inversiones','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93917,'3810','De propiedades, planta y equipo','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93918,'3895','De otros activos','PATRIMONIO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93930,'4110','Pesca','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93931,'4115','Explotacion de minas y canteras','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93932,'4125','Suministro de electricidad, gas y agua','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93933,'420505','Materia prima','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93934,'420510','Material de desecho','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93935,'420515','Materiales varios','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93936,'420520','Productos de diversificacion','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93937,'420545','Envases y empaques','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93938,'421005','Intereses','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93939,'421010','Reajuste monetario-UPAC (UVR)','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93940,'421015','Descuentos amortizados','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93941,'421020','Diferencia en cambio','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93942,'421025','Financiacion vehiculos','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93943,'421030','Financiacion sistemas de viajes','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93944,'421035','Aceptaciones bancarias','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93945,'421095','Otros','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93946,'4218','Ingresos metodo de participacion','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93947,'422005','Terrenos','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93948,'422010','Construcciones y edificaciones','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93949,'422015','Maquinaria y equipo','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93950,'422095','Otros','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93951,'423505','De acarreo','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93952,'423540','De transporte','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93953,'423595','Otros','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93954,'4240','Utilidad en venta de inversiones','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93955,'4245','Utilidad en venta de propiedades, planta y equipo','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93956,'4248','Utilidad en venta de otros bienes','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93957,'4250','Recuperaciones','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93958,'425005','Deudas malas','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93959,'425010','Seguros','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93960,'425035','Descuentos concedidos (recuperados)','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93961,'425050','Reintegro de otros costos y gastos','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93962,'4260','Participaciones en concesiones','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93963,'4265','Ingresos de ejercicios anteriores','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93964,'4275','Devoluciones en otras ventas (DB)','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93965,'429505','Aprovechamientos','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93966,'429515','Excedentes','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93967,'429525','Multas y recargos','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93968,'429545','Subvenciones','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93969,'429581','Ajuste al peso','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93970,'429595','Otros','INGRESO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93971,'47','Ajustes por inflacion','INGRESO',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93972,'4705','Correccion monetaria','INGRESO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93997,'510503','Salario integral','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93998,'510506','Sueldos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(93999,'510512','Jornales','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94000,'510515','Horas extras y recargos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94001,'510518','Comisiones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94002,'510521','Viaticos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94003,'510524','Incapacidades','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94004,'510527','Auxilio de transporte','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94005,'510530','Cesantias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94006,'510533','Intereses sobre cesantias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94007,'510536','Prima de servicios','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94008,'510539','Vacaciones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94009,'510542','Primas extralegales','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94010,'510545','Auxilios','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94011,'510548','Bonificaciones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94012,'510551','Dotacion y suministro a trabajadores','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94013,'510554','Seguros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94014,'510557','Cuotas partes pensiones de jubilacion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94015,'510558','Amortizacion calculo actuarial pensiones de jubilacion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94016,'510559','Pensiones de jubilacion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94017,'510560','Indemnizaciones laborales','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94018,'510561','Amortizacion bonos pensionales','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94019,'510563','Capacitacion al personal','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94020,'510566','Gastos deportivos y de recreacion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94021,'510568','Aportes a administradoras de riesgos laborales (ARL)','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94022,'510569','Aportes a entidades promotoras de salud (EPS)','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94023,'510570','Aportes a fondos de pensiones y/o cesantias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94024,'510572','Aportes a cajas de compensacion familiar','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94025,'510575','Aportes al ICBF','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94026,'510578','SENA','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94027,'510584','Gastos medicos y drogas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94028,'510595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94029,'511005','Junta directiva','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94030,'511010','Revisoria fiscal','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94031,'511015','Auditoria externa','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94032,'511020','Avaluos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94033,'511025','Asesoria juridica','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94034,'511030','Asesoria financiera','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94035,'511035','Asesoria tecnica','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94036,'511095','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94037,'511505','Industria y comercio','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94038,'511510','De timbres','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94039,'511515','A la propiedad raiz','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94040,'511520','Derechos sobre instrumentos publicos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94041,'511525','De valorizacion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94042,'511540','De vehiculos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94043,'511570','IVA descontable','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94044,'511595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94045,'512005','Terrenos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94046,'512010','Construcciones y edificaciones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94047,'512015','Maquinaria y equipo','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94048,'512020','Equipo de oficina','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94049,'512025','Equipo de computacion y comunicacion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94050,'512040','Flota y equipo de transporte','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94051,'512095','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94052,'512505','Contribuciones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94053,'512510','Afiliaciones y sostenimiento','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94054,'513005','Manejo','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94055,'513010','Cumplimiento','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94056,'513025','Incendio','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94057,'513030','Terremoto','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94058,'513035','Sustraccion y hurto','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94059,'513040','Flota y equipo de transporte','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94060,'513095','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94061,'513505','Aseo y vigilancia','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94062,'513510','Temporales','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94063,'513515','Asistencia tecnica','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94064,'513520','Procesamiento electronico de datos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94065,'513525','Acueducto y alcantarillado','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94066,'513530','Energia electrica','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94067,'513540','Correo, portes y telegramas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94068,'513545','Fax y telex','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94069,'513550','Transporte, fletes y acarreos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94070,'513555','Gas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94071,'513595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94072,'514005','Notariales','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94073,'514010','Registro mercantil','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94074,'514015','Tramites y licencias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94075,'514095','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94076,'514505','Terrenos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94077,'514510','Construcciones y edificaciones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94078,'514515','Maquinaria y equipo','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94079,'514520','Equipo de oficina','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94080,'514525','Equipo de computacion y comunicacion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94081,'514540','Flota y equipo de transporte','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94082,'514595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94083,'515005','Instalaciones electricas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94084,'515010','Arreglos ornamentales','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94085,'515015','Reparaciones locativas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94086,'515095','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94087,'515505','Alojamiento y manutencion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94088,'515510','Pasajes fluviales y/o maritimos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94089,'515515','Pasajes aereos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94090,'515520','Pasajes terrestres','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94091,'515595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94092,'516005','Construcciones y edificaciones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94093,'516010','Maquinaria y equipo','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94094,'516015','Equipo de oficina','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94095,'516020','Equipo de computacion y comunicacion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94096,'516035','Flota y equipo de transporte','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94097,'516505','Intangibles','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94098,'516510','Cargos diferidos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94099,'519505','Comisiones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94100,'519510','Libros, suscripciones, periodicos y revistas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94101,'519515','Musica ambiental','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94102,'519520','Gastos de representacion y relaciones publicas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94103,'519525','Elementos de aseo y cafeteria','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94104,'519530','Utiles, papeleria y fotocopias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94105,'519535','Combustibles y lubricantes','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94106,'519540','Envases y empaques','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94107,'519545','Taxis y buses','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94108,'519550','Estampillas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94109,'519555','Microfilmacion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94110,'519560','Casino y restaurante','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94111,'519565','Parqueaderos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94112,'519595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94113,'5199','Provisiones','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94114,'519905','Inversiones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94115,'519910','Deudores','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94116,'519915','Propiedades, planta y equipo','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94117,'520503','Salario integral','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94118,'520506','Sueldos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94119,'520515','Horas extras y recargos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94120,'520518','Comisiones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94121,'520527','Auxilio de transporte','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94122,'520530','Cesantias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94123,'520533','Intereses sobre cesantias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94124,'520536','Prima de servicios','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94125,'520539','Vacaciones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94126,'520551','Dotacion y suministro a trabajadores','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94127,'520568','Aportes a administradoras de riesgos laborales (ARL)','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94128,'520569','Aportes a entidades promotoras de salud (EPS)','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94129,'520570','Aportes a fondos de pensiones y/o cesantias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94130,'520572','Aportes a cajas de compensacion familiar','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94131,'520575','Aportes al ICBF','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94132,'520578','SENA','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94133,'520595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94134,'5210','Honorarios','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94135,'5215','Impuestos','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94136,'521505','Industria y comercio','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94137,'521595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94138,'5220','Arrendamientos','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94139,'5225','Contribuciones y afiliaciones','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94140,'5230','Seguros','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94141,'523505','Aseo y vigilancia','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94142,'523525','Acueducto y alcantarillado','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94143,'523530','Energia electrica','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94144,'523535','Telefono','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94145,'523550','Transporte, fletes y acarreos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94146,'523560','Publicidad, propaganda y promocion','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94147,'523595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94148,'5240','Gastos legales','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94149,'5245','Mantenimiento y reparaciones','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94150,'5250','Adecuacion e instalacion','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94151,'5255','Gastos de viaje','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94152,'5260','Depreciaciones','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94153,'5265','Amortizaciones','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94154,'5270','Financieros-reajuste del sistema','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94155,'5275','Perdidas metodo de participacion','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94156,'529505','Comisiones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94157,'529520','Gastos de representacion y relaciones publicas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94158,'529525','Elementos de aseo y cafeteria','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94159,'529530','Utiles, papeleria y fotocopias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94160,'529535','Combustibles y lubricantes','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94161,'529540','Envases y empaques','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94162,'529595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94163,'5299','Provisiones','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94164,'530505','Gastos bancarios','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94165,'530510','Reajuste monetario-UPAC (UVR)','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94166,'530515','Comisiones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94167,'530520','Intereses','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94168,'530525','Diferencia en cambio','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94169,'530530','Gastos en negociacion certificados de cambio','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94170,'530540','Descuentos comerciales condicionados','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94171,'530595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94172,'531005','Venta de inversiones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94173,'531010','Venta de cartera','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94174,'531015','Venta de propiedades, planta y equipo','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94175,'531020','Venta de intangibles','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94176,'531025','Venta de otros activos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94177,'531040','Retiro de propiedades, planta y equipo','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94178,'531095','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94179,'5313','Perdidas metodo de participacion','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94180,'531505','Costas y procesos judiciales','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94181,'531510','Actividades culturales y civicas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94182,'531515','Costos y gastos de ejercicios anteriores','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94183,'531520','Impuestos asumidos','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94184,'531595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94185,'539505','Demandas laborales','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94186,'539515','Indemnizaciones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94187,'539520','Multas, sanciones y litigios','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94188,'539525','Donaciones','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94189,'539530','Constitucion de garantias','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94190,'539595','Otros','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94191,'5405','Impuesto de renta y complementarios','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94192,'540505','Impuesto de renta y complementarios','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94193,'59','Ganancias y perdidas','GASTO',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94194,'5905','Ganancias y perdidas','GASTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94195,'590505','Ganancias y perdidas','GASTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94223,'6105','Agricultura, ganaderia, caza y silvicultura','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94224,'6110','Pesca','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94225,'6115','Explotacion de minas y canteras','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94226,'6120','Industrias manufactureras','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94227,'6125','Suministro de electricidad, gas y agua','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94228,'6130','Construccion','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94229,'613505','Venta de mercancias','COSTO',4,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94230,'6140','Hoteles y restaurantes','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94231,'6145','Transporte, almacenamiento y comunicaciones','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94232,'6150','Actividad financiera','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94233,'6155','Actividades inmobiliarias, empresariales y de alquiler','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94234,'6160','Ensenanza','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94235,'6165','Servicios sociales y de salud','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94236,'6170','Otras actividades de servicios comunitarios, sociales y personales','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94237,'6215','De materiales indirectos','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94238,'6220','Compra de energia','COSTO',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94246,'74','Contratos de servicios','COSTO_PRODUCCION',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94251,'8115','Bienes y valores en poder de terceros','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94252,'8125','Promesas de compraventa','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94253,'8195','Diversas','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94254,'82','Deudoras fiscales','ORDEN_DEUDORAS',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94255,'8305','Bienes recibidos en arrendamiento financiero','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94256,'8310','Titulos de inversion no colocados','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94257,'8320','Creditos a favor no utilizados','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94258,'8325','Activos castigados','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94259,'8330','Titulos de inversion amortizados','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94260,'8335','Capitalizacion por revalorizacion del patrimonio','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94261,'8395','Otras cuentas deudoras de control','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94262,'8399','Ajustes por inflacion activos','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94263,'85','Deudoras fiscales por contra (CR)','ORDEN_DEUDORAS',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94264,'86','Deudoras de control por contra (CR)','ORDEN_DEUDORAS',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94265,'8605','Deudoras de control por contra (CR)','ORDEN_DEUDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94275,'9115','Bienes y valores recibidos de terceros','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94276,'9125','Promesas de compraventa','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94277,'9130','Contratos de administracion delegada','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94278,'9135','Cuentas en participacion','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94279,'9195','Otras responsabilidades contingentes','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94280,'92','Acreedoras fiscales','ORDEN_ACREEDORAS',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94281,'9305','Contratos de arrendamiento financiero','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94282,'9399','Ajustes por inflacion patrimonio','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94283,'95','Acreedoras fiscales por contra (DB)','ORDEN_ACREEDORAS',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94284,'96','Acreedoras de control por contra (DB)','ORDEN_ACREEDORAS',2,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0),(94285,'9605','Acreedoras de control por contra (DB)','ORDEN_ACREEDORAS',3,NULL,0,'ACTIVO','2026-07-25 19:43:53',0,0,0);
...
INSERT INTO `departamentos` VALUES (1,169,5,'ANTIOQUIA'),(2,169,8,'ATLANTICO'),(3,169,11,'BOGOTA'),(4,169,13,'BOLIVAR'),(5,169,15,'BOYACA'),(6,169,17,'CALDAS'),(7,169,18,'CAQUETA'),(8,169,19,'CAUCA'),(9,169,20,'CESAR'),(10,169,23,'CORDOBA'),(11,169,25,'CUNDINAMARCA'),(12,169,27,'CHOCO'),(13,169,41,'HUILA'),(14,169,44,'LA GUAJIRA'),(15,169,47,'MAGDALENA'),(16,169,50,'META'),(17,169,52,'NARIÑO'),(18,169,54,'N. DE SANTANDER'),(19,169,63,'QUINDIO'),(20,169,66,'RISARALDA'),(21,169,68,'SANTANDER'),(22,169,70,'SUCRE'),(23,169,73,'TOLIMA'),(24,169,76,'VALLE DEL CAUCA'),(25,169,81,'ARAUCA'),(26,169,85,'CASANARE'),(27,169,86,'PUTUMAYO'),(28,169,88,'SAN ANDRES'),(29,169,91,'AMAZONAS'),(30,169,94,'GUAINIA'),(31,169,95,'GUAVIARE'),(32,169,97,'VAUPES'),(33,169,99,'VICHADA'),(34,0,0,'NA');
...
--
-- Dumping data for table `depreciacion_detalle`
--

LOCK TABLES `depreciacion_detalle` WRITE;
/*!40000 ALTER TABLE `depreciacion_detalle` DISABLE KEYS */;
/*!40000 ALTER TABLE `depreciacion_detalle` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `documentos_electronicos`
--

LOCK TABLES `documentos_electronicos` WRITE;
/*!40000 ALTER TABLE `documentos_electronicos` DISABLE KEYS */;
/*!40000 ALTER TABLE `documentos_electronicos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `flyway_schema_history` VALUES (0,NULL,'<< Flyway Schema Creation >>','SCHEMA','`_tenant_template`',NULL,'root','2026-07-17 14:51:41',0,1),(1,'1','estructura tablas','SQL','V1__estructura_tablas.sql',-1459868740,'root','2026-07-17 14:53:06',1277,1),(2,'2','datos iniciales','SQL','V2__datos_iniciales.sql',-1419364324,'root','2026-07-17 15:34:58',7724,1),(3,'3','funciones y procedimientos','SQL','V3__agregar_clave_parametros.sql',1350301554,'root','2026-07-21 12:58:35',130,1),(4,'4','fix encoding','SQL','V4__fix_encoding.sql',-1584752305,'root','2026-07-28 20:38:49',324,1),(5,'5','indexes performance','SQL','V5__indexes_performance.sql',1452458973,'root','2026-07-30 19:53:48',2836,1),(6,'6','subpermisos','SQL','V6__subpermisos.sql',-2020532993,'root','2026-07-31 14:53:59',36,1);
...
--
-- Table structure for table `manifestoimportacion`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `manifestoimportacion` (
  `codigo` int NOT NULL AUTO_INCREMENT,
  `numero_manifiesto` varchar(50) NOT NULL,
  `fecha_importacion` date NOT NULL,
  `pais_origen` varchar(100) DEFAULT NULL,
  `puerto_embarque` varchar(100) DEFAULT NULL,
  `puerto_arribo` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `manifestoimportacion`
--

LOCK TABLES `manifestoimportacion` WRITE;
/*!40000 ALTER TABLE `manifestoimportacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `manifestoimportacion` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `metodos_pago_facturas` WRITE;
/*!40000 ALTER TABLE `metodos_pago_facturas` DISABLE KEYS */;
/*!40000 ALTER TABLE `metodos_pago_facturas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `notas_estados_financieros`
--

LOCK TABLES `notas_estados_financieros` WRITE;
/*!40000 ALTER TABLE `notas_estados_financieros` DISABLE KEYS */;
/*!40000 ALTER TABLE `notas_estados_financieros` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `nuevosimpuestos`
--

LOCK TABLES `nuevosimpuestos` WRITE;
/*!40000 ALTER TABLE `nuevosimpuestos` DISABLE KEYS */;
/*!40000 ALTER TABLE `nuevosimpuestos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `parametros` VALUES (52,NULL,'Movimiento sin costo','GENERALES','ENTRADA','ACTIVO','TEXTO','SI/NO','SI,NO'),

(53,NULL,'Movimiento sin costo','GENERALES','SALIDA','ACTIVO','TEXTO','SI/NO','SI,NO'),
(54,NULL,'Movimiento sin costo','GENERALES','TRASLADO','ACTIVO','TEXTO','SI/NO','SI,NO'),
(55,NULL,'Aplica centro costo','GENERALES','COMPRA','ACTIVO','TEXTO','SI/NO','SI,NO'),
(56,NULL,'Aplica centro costo','GENERALES','ENTRADA','ACTIVO','TEXTO','SI/NO','SI,NO'),
(57,NULL,'Aplica centro costo','GENERALES','SALIDA','ACTIVO','TEXTO','SI/NO','SI,NO'),
(58,NULL,'Aplica centro costo','GENERALES','TRASLADO','ACTIVO','TEXTO','SI/NO','SI,NO'),
(59,NULL,'Aplica centro costo','GENERALES','VENTA','ACTIVO','TEXTO','SI/NO','SI,NO');
...
INSERT INTO `permisos` VALUES (8,'Mi Panel'),(9,'Usuarios'),(10,'Terceros'),(11,'Inventarios'),(12,'Compras'),(14,'Ventas'),(15,'Caja'),(16,'Nomina'),(17,'Contabilidad'),(18,'Reportes'),(19,'Parametros');
...
INSERT INTO `regimen` VALUES (1,'48','Responsable de iva','ACTIVO'),(2,'49','No responsable de iva','ACTIVO'),(3,'47','Regimen simple de tributación','ACTIVO'),(4,'50','Grande contribuyente','ACTIVO');
...
LOCK TABLES `tipo_totales` WRITE;
/*!40000 ALTER TABLE `tipo_totales` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tipo_totales` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `tipo_totales_facturas` WRITE;
/*!40000 ALTER TABLE `tipo_totales_facturas` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipo_totales_facturas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `tipos_comprobante_manual`
--

LOCK TABLES `tipos_comprobante_manual` WRITE;
/*!40000 ALTER TABLE `tipos_comprobante_manual` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipos_comprobante_manual` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `comprobante_cajero`
--
...
--
-- Dumping data for table `comprobante_cajero`
--

LOCK TABLES `comprobante_cajero` WRITE;
/*!40000 ALTER TABLE `comprobante_cajero` DISABLE KEYS */;
/*!40000 ALTER TABLE `comprobante_cajero` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `origen_destino_inventario`
--

LOCK TABLES `origen_destino_inventario` WRITE;
/*!40000 ALTER TABLE `origen_destino_inventario` DISABLE KEYS */;
/*!40000 ALTER TABLE `origen_destino_inventario` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `paracomprobantes` (
  ...
  CONSTRAINT `paracomprobantes_ibfk_1` FOREIGN KEY (`parametroid`) REFERENCES `parametros` (`id`),
  CONSTRAINT `paracomprobantes_ibfk_2` FOREIGN KEY (`comprobanteContableid`) REFERENCES `comprobantes_contables` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paracomprobantes`
--

LOCK TABLES `paracomprobantes` WRITE;
/*!40000 ALTER TABLE `paracomprobantes` DISABLE KEYS */;
/*!40000 ALTER TABLE `paracomprobantes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `parametroscomprobantes`
--

LOCK TABLES `parametroscomprobantes` WRITE;
/*!40000 ALTER TABLE `parametroscomprobantes` DISABLE KEYS */;
/*!40000 ALTER TABLE `parametroscomprobantes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `parametrosglobales`
--

LOCK TABLES `parametrosglobales` WRITE;
/*!40000 ALTER TABLE `parametrosglobales` DISABLE KEYS */;
/*!40000 ALTER TABLE `parametrosglobales` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `subpermisos`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `subpermisos` (
  `codigo` int NOT NULL AUTO_INCREMENT,
  ...
  `activo` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`codigo`),
  KEY `fk_subpermiso_padre` (`permiso_padre_id`),
  CONSTRAINT `fk_subpermiso_padre` FOREIGN KEY (`permiso_padre_id`) REFERENCES `permisos` (`codigo`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `subpermisos`
--

LOCK TABLES `subpermisos` WRITE;
/*!40000 ALTER TABLE `subpermisos` DISABLE KEYS */;
--
-- Dumping data for table `subpermisos`
--
...
LOCK TABLES `subpermisos` WRITE;
/*!40000 ALTER TABLE `subpermisos` DISABLE KEYS */;
INSERT INTO `subpermisos` VALUES (1,9,'ingresar_Rol','Roles',1),(2,9,'ingresar_Usuarios','Usuarios',1),(3,11,'ingresar_Atributos','Atributos',1),(4,11,'ingresar_Productos','Productos',1),(5,11,'ingresar_Movimientos','Movimientos',1),(6,11,'ingresar_Kardex','Kardex',1),(7,12,'ingresar_Compras','Compras',1),(8,12,'ingresar_Docomentos soporte','Documentos soporte',1),(9,12,'ingresa_Notas de ajuste','Notas de ajuste',1),(10,14,'ingresar_Vendedores','Vendedores',1),(11,14,'ingresar_Facturacion','Facturación',1),(12,14,'ingresar_Cotizaciones','Cotizaciones',1),(13,14,'ingresar_Pedidos','Pedidos',1),(14,14,'ingresar_Devoluciones','Devoluciones',1),(15,14,'ingresar_Despachos','Despachos',1),(16,15,'ingresar_Cajeros','Cajeros',1),(17,15,'ingresar_Recibos','Recibos',1),(18,15,'ingresar_Egresos','Egresos',1),(19,15,'ingresar_Cuade de caja','Cuadre de caja',1),(20,17,'ingresa_Plan de cuentasr','Plan de cuentas',1),(21,17,'ingresar_Comprobantes','Comprobantes',1),(22,17,'ingresar_Acientos contables','Acientos contables',1),(23,17,'ingresa_Reportes contables','Reportes contables',1),(24,17,'ingresar_Caja y bancos','Caja y bancos',1),(25,17,'ingresar_Documentos','Documentos',1),(26,17,'ingresar_Informacion exógena','Información exógena',1),(27,17,'ingresar_Conceptos abiertos','Conceptos abiertos',1),(28,17,'ingresar_Metodos de pago','Metodos de pago',1),(29,17,'ingresar_Retenciones','Retenciones',1),(30,17,'ingresar_Certificados de retencion','Certificados  de retención',1);
/*!40000 ALTER TABLE `subpermisos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `anexos_terceros_terceros`
--
...
LOCK TABLES `anexos_terceros_terceros` WRITE;
/*!40000 ALTER TABLE `anexos_terceros_terceros` DISABLE KEYS */;
/*!40000 ALTER TABLE `anexos_terceros_terceros` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `comprobantes_egreso`
--

LOCK TABLES `comprobantes_egreso` WRITE;
/*!40000 ALTER TABLE `comprobantes_egreso` DISABLE KEYS */;
/*!40000 ALTER TABLE `comprobantes_egreso` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `conceptos_abiertos`
--

LOCK TABLES `conceptos_abiertos` WRITE;
/*!40000 ALTER TABLE `conceptos_abiertos` DISABLE KEYS */;
/*!40000 ALTER TABLE `conceptos_abiertos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `contactos_tercero`
--

LOCK TABLES `contactos_tercero` WRITE;
/*!40000 ALTER TABLE `contactos_tercero` DISABLE KEYS */;
/*!40000 ALTER TABLE `contactos_tercero` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `detalle_cajero`
--

LOCK TABLES `detalle_cajero` WRITE;
/*!40000 ALTER TABLE `detalle_cajero` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalle_cajero` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `facturas` (
  ...
  UNIQUE KEY `uq_facturas_comp_consec` (`comprobante_id`,`consecutivo`),
  UNIQUE KEY `uq_facturas_venta` (`venta_id`),
  UNIQUE KEY `uq_facturas_prefijo_consec` (`prefijo`,`consecutivo`),
  KEY `comprobante_id` (`comprobante_id`),
  KEY `tercero_id` (`tercero_id`),
...
--
-- Dumping data for table `item_transacciones`
--

LOCK TABLES `item_transacciones` WRITE;
/*!40000 ALTER TABLE `item_transacciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_transacciones` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ordenes_compra` (
  ...
  KEY `idx_oc_estado_fecha` (`estado`,`fecha_emision`),
  KEY `idx_oc_proveedor_estado` (`proveedor_id`,`estado`),
  KEY `idx_oc_bodega_fecha` (`bodega_id`,`fecha_emision`),
...
--
-- Dumping data for table `recibos_caja`
--
...
--
-- Dumping data for table `resoluciones_comprobantes`
--

LOCK TABLES `resoluciones_comprobantes` WRITE;
/*!40000 ALTER TABLE `resoluciones_comprobantes` DISABLE KEYS */;
/*!40000 ALTER TABLE `resoluciones_comprobantes` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `retenciones_terceros` WRITE;
/*!40000 ALTER TABLE `retenciones_terceros` DISABLE KEYS */;
/*!40000 ALTER TABLE `retenciones_terceros` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sedes_tercero`
--

LOCK TABLES `sedes_tercero` WRITE;
/*!40000 ALTER TABLE `sedes_tercero` DISABLE KEYS */;
/*!40000 ALTER TABLE `sedes_tercero` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `subpermisos_roles`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `subpermisos_roles` (
  `codigo` int NOT NULL AUTO_INCREMENT,
  ...
  `fechacreado` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`codigo`),
  KEY `fk_subpermisrol_rol` (`codigorol`),
  KEY `fk_subpermisrol_sub` (`codigosubpermiso`),
  CONSTRAINT `fk_subpermisrol_rol` FOREIGN KEY (`codigorol`) REFERENCES `roles` (`codigo`) ON DELETE CASCADE,
  CONSTRAINT `fk_subpermisrol_sub` FOREIGN KEY (`codigosubpermiso`) REFERENCES `subpermisos` (`codigo`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `subpermisos_roles`
--

LOCK TABLES `subpermisos_roles` WRITE;
/*!40000 ALTER TABLE `subpermisos_roles` DISABLE KEYS */;
INSERT INTO `subpermisos_roles` VALUES (6,6,1,'ACTIVO',0,'2026-08-04 12:14:53'),(7,6,2,'ACTIVO',0,'2026-08-04 12:27:29'),(8,6,7,'ACTIVO',0,'2026-08-04 12:27:33'),(11,6,3,'ACTIVO',0,'2026-08-04 12:27:39'),(12,6,6,'ACTIVO',0,'2026-08-04 12:27:40'),(13,6,5,'ACTIVO',0,'2026-08-04 12:27:41'),(14,6,4,'ACTIVO',0,'2026-08-04 12:27:41'),(15,6,12,'ACTIVO',0,'2026-08-04 13:31:32'),(16,6,15,'ACTIVO',0,'2026-08-04 13:31:32'),(17,6,14,'ACTIVO',0,'2026-08-04 13:31:33'),(18,6,11,'ACTIVO',0,'2026-08-04 13:31:33'),(19,6,13,'ACTIVO',0,'2026-08-04 13:31:35'),(20,6,10,'ACTIVO',0,'2026-08-04 13:31:35'),(21,6,16,'ACTIVO',0,'2026-08-04 13:31:44'),(22,6,19,'ACTIVO',0,'2026-08-04 13:31:45'),(23,6,18,'ACTIVO',0,'2026-08-04 13:31:45'),(24,6,17,'ACTIVO',0,'2026-08-04 13:31:47'),(25,6,22,'ACTIVO',0,'2026-08-04 13:31:52'),(26,6,24,'ACTIVO',0,'2026-08-04 13:31:53'),(27,6,30,'ACTIVO',0,'2026-08-04 13:31:54'),(28,6,21,'ACTIVO',0,'2026-08-04 13:31:55'),(29,6,27,'ACTIVO',0,'2026-08-04 13:31:55'),(30,6,25,'ACTIVO',0,'2026-08-04 13:31:56'),(31,6,26,'ACTIVO',0,'2026-08-04 13:31:56'),(32,6,28,'ACTIVO',0,'2026-08-04 13:31:58'),(33,6,20,'ACTIVO',0,'2026-08-04 13:31:58'),(34,6,23,'ACTIVO',0,'2026-08-04 13:31:59'),(35,6,29,'ACTIVO',0,'2026-08-04 13:31:59'),(36,6,8,'ACTIVO',0,'2026-08-04 13:56:58'),(37,6,9,'ACTIVO',0,'2026-08-04 13:56:58');

/*!40000 ALTER TABLE `subpermisos_roles` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `unidades_medida_producto` WRITE;
/*!40000 ALTER TABLE `unidades_medida_producto` DISABLE KEYS */;
/*!40000 ALTER TABLE `unidades_medida_producto` ENABLE KEYS */;
UNLOCK TABLES;



--
-- Table structure for table `usuarios_vendedor`
--
...
--
-- Dumping data for table `usuarios_vendedor`
--

LOCK TABLES `usuarios_vendedor` WRITE;
/*!40000 ALTER TABLE `usuarios_vendedor` DISABLE KEYS */;
/*!40000 ALTER TABLE `usuarios_vendedor` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping events for database '_tenant_template'
--
...
--
-- Dumping data for table `comprobante_egreso_medio_pago`
--

LOCK TABLES `comprobante_egreso_medio_pago` WRITE;
/*!40000 ALTER TABLE `comprobante_egreso_medio_pago` DISABLE KEYS */;
/*!40000 ALTER TABLE `comprobante_egreso_medio_pago` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `detalle_comprobante_egreso`
--

LOCK TABLES `detalle_comprobante_egreso` WRITE;
/*!40000 ALTER TABLE `detalle_comprobante_egreso` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalle_comprobante_egreso` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `detalles_orden_compra` (
  ...
  KEY `idx_doc_codigo_producto` (`codigo_producto`),
...
--
-- Dumping data for table `devoluciones_compra`
--

LOCK TABLES `devoluciones_compra` WRITE;
/*!40000 ALTER TABLE `devoluciones_compra` DISABLE KEYS */;
/*!40000 ALTER TABLE `devoluciones_compra` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `legalizaciones` (
  ...
  KEY `idx_leg_proveedor_id` (`proveedor_id`),
...
--
-- Dumping data for table `manifestos_importacion`
--

LOCK TABLES `manifestos_importacion` WRITE;
/*!40000 ALTER TABLE `manifestos_importacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `manifestos_importacion` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `movimiento_cajero`
--

LOCK TABLES `movimiento_cajero` WRITE;
/*!40000 ALTER TABLE `movimiento_cajero` DISABLE KEYS */;
/*!40000 ALTER TABLE `movimiento_cajero` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `movimientos_inventario_detalles`
--

LOCK TABLES `movimientos_inventario_detalles` WRITE;
/*!40000 ALTER TABLE `movimientos_inventario_detalles` DISABLE KEYS */;
/*!40000 ALTER TABLE `movimientos_inventario_detalles` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `orden_compra_metodos_pago`
--

LOCK TABLES `orden_compra_metodos_pago` WRITE;
/*!40000 ALTER TABLE `orden_compra_metodos_pago` DISABLE KEYS */;
/*!40000 ALTER TABLE `orden_compra_metodos_pago` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `precios_producto_variante`
--

LOCK TABLES `precios_producto_variante` WRITE;
/*!40000 ALTER TABLE `precios_producto_variante` DISABLE KEYS */;
/*!40000 ALTER TABLE `precios_producto_variante` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `producto_variantes_detalle`
--

LOCK TABLES `producto_variantes_detalle` WRITE;
/*!40000 ALTER TABLE `producto_variantes_detalle` DISABLE KEYS */;
/*!40000 ALTER TABLE `producto_variantes_detalle` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `recibo_caja_medio_pago`
--

LOCK TABLES `recibo_caja_medio_pago` WRITE;
/*!40000 ALTER TABLE `recibo_caja_medio_pago` DISABLE KEYS */;
/*!40000 ALTER TABLE `recibo_caja_medio_pago` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `detalle_recibo_caja`
--

LOCK TABLES `detalle_recibo_caja` WRITE;
/*!40000 ALTER TABLE `detalle_recibo_caja` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalle_recibo_caja` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `detalles_devolucion_compra`
--

LOCK TABLES `detalles_devolucion_compra` WRITE;
/*!40000 ALTER TABLE `detalles_devolucion_compra` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalles_devolucion_compra` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `detalles_devolucion_venta`
--

LOCK TABLES `detalles_devolucion_venta` WRITE;
/*!40000 ALTER TABLE `detalles_devolucion_venta` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalles_devolucion_venta` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping routines for database '_tenant_template'
--
...
CREATE FUNCTION `fn_cajero_tiene_z_pendiente`(p_cajero_id INT) RETURNS tinyint(1)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
CREATE PROCEDURE `verificar_relaciones_bodega`(
...
-- Dump completed on 2026-08-04 14:48:58
