...
-- =============================================================================
-- PRE-CLEANUP: Drop all tables from V1 in reverse dependency order.
-- Required by MySQL 8.0: even with FOREIGN_KEY_CHECKS=0, recreating a parent
-- table fails if orphaned FK metadata from V1 child tables still references old
-- column names. Dropping children first removes that metadata cleanly.
-- =============================================================================

-- Leaf / most-dependent tables first (level 5)
...
-- Tables introduced in V2 (not in V1)
...
-- (DROP only here; CREATE moved after comprobantes_egreso is recreated below)
--
...
--
-- Table structure for table `comprobante_egreso_medio_pago` (moved here so it follows comprobantes_egreso)
--
...
INSERT INTO parametros (id, clave, nombre, categoriaParametro, categoriaComprobante, estado, tipoDato) VALUES
 (52,	null ,	'Movimiento sin costo'	,'GENERALES',	'AJUSTE',	'ACTIVO',	'TEXTO');
