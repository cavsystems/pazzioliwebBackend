-- Portado de db_migrations/2026_07_16_fix_facturas_fk_comprobante.sql
...
-- Idempotente: solo elimina la FK si existe (DATABASE() = el schema que Flyway está migrando).
