...
) ENGINE=InnoDB AUTO_INCREMENT=93296 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=93317 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=93293 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=93314 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `movimientos_inventario` (
  ...
  `estado_movimiento` enum('ACTIVO','ANULADO','BORRADOR') DEFAULT NULL,
  `total` decimal(10,0) DEFAULT NULL,
  `observaciones` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`movimiento_inventario_id`),
  KEY `comprobante_id` (`comprobante_id`),
  CONSTRAINT `movimientos_inventario_ibfk_1` FOREIGN KEY (`comprobante_id`) REFERENCES `usuarios` (`codigo`)
...
--
INSERT INTO `permisos` VALUES (1,'Manejo de caja'),(2,'Facturacion POS'),(3,'devoluciones'),(4,'creacion de recibo de ingresos'),(5,'creacionusuario'),(6,'creacionsuperusuario'),(7,'creacionsuperusuarioadministrador'),(8,'creacionempresa'),(9,'VENTA'),(10,'Anular comprobantes'),(11,'Reportes generales');
...
--
INSERT INTO `roles` VALUES (1,'Admin'),(5,'Adminsede');
...
) ENGINE=InnoDB AUTO_INCREMENT=93322 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-05 15:32:41
