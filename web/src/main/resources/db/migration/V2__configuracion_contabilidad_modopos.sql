...
-- (`_tenant_template`). Flyway aplica esta versión al template en el arranque; luego cada empresa
-- nueva se CLONA del template (CREATE TABLE ... LIKE + INSERT ... SELECT), por lo que hereda esta tabla.
--
