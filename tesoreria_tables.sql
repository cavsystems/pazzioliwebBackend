...
--     mysql -u root -p <tenant> < tesoreria_tables.sql
...
ALTER TABLE recibos_caja ADD COLUMN concepto_abierto BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE recibos_caja ADD COLUMN monto_concepto_abierto DECIMAL(18,2) NULL;
ALTER TABLE recibos_caja MODIFY COLUMN tercero_id INT NULL;

-- Migración: concepto abierto en comprobantes_egreso
ALTER TABLE comprobantes_egreso ADD COLUMN concepto_abierto BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE comprobantes_egreso ADD COLUMN monto_concepto_abierto DECIMAL(18,2) NULL;
ALTER TABLE comprobantes_egreso MODIFY COLUMN tercero_id INT NULL;

-- Migración: fecha_egreso y medios de pago múltiples en comprobantes_egreso
ALTER TABLE comprobantes_egreso ADD COLUMN fecha_egreso DATE NULL;
ALTER TABLE comprobantes_egreso MODIFY COLUMN concepto TEXT;
