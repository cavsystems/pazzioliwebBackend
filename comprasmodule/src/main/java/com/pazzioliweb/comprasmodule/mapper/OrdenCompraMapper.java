...
public interface OrdenCompraMapper {
    ...
    @Mapping(target = "retefuente", source = "retefuente")
    @Mapping(target = "reteiva", source = "reteiva")
    @Mapping(target = "reteica", source = "reteica")
    @Mapping(target = "usuarioCreacion", source = "usuarioCreacion")
    @Mapping(target = "fechaCreacion", source = "fechaCreacion")
    @Mapping(target = "fechaRecibida", source = "fechaRecibida")
    ...
    @Mapping(target = "cajeroId", ignore = true)
    @Mapping(target = "comprobante", ignore = true)
    @Mapping(target = "consecutivoComprobante", ignore = true)
